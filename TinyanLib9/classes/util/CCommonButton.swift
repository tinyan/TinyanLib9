...
public class CCommonButton : SKSpriteNode
{
	...
	public func addTouchSprite(size:CGSize)
	{
		...
		let touchSprite = SKSpriteNode(texture: nil, size: size)
	...
	public func addSprite(sprite sprite : SKSpriteNode , point:CGPoint , name:String = "default")
	{
		sprite.name = name
	...
	{
		if let sprite = self.childNodeWithName(name)
		{
//			println("found!")
